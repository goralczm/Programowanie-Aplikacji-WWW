...
<div class="container">
    <article>
        <h1>Dodaj Produkt</h1>
        <form action="php/produkty/dodaj_produkt.php" method="post" class="container">
...
<div class="container">
    <article>
        ...
        <form action="php/produkty/edytuj_produkt.php" method="post" class="container">
